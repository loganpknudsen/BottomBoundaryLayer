...
gr_data.to_netcdf("PSI_non_dim_full_form.nc")
...
# z_data = xr.Dataset(grid_normal)
field_data.to_netcdf("PSI_non_dim_field.nc")
# z_data.to_netcdf("PSI_non_dim_z_data.nc")
