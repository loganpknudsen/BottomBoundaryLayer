...
@with_kw struct DenseParams
    ...
    f1e4theta04530N21e5delta05Vinf01gammau = (f = 1e-4,
        ...
        γ = (cosd(0.453)*(1+(1e-5*tand(0.453)^2)/((1e-4)^2)*(1-0.5)))^(-1),
    )
    f1e4theta04530N21e5delta05Vinf01gammam = (f = 1e-4,
        ...
        V∞ = 0.1,
        S∞ = (1e-5*tand(0.453)^2)/((1e-4)^2),
        γ = ((cosd(0.453)*(1+0.5*1e-5*tand(0.453)^2*10^(8)))^(-1)+(3-1e-5*tand(0.453)^2*10^(8))*(cosd(0.453)*(3*(1+1e-5*tand(0.453)^2*10^(8))-4*0.5*1e-5*tand(0.453)^2*(10)^(8)))^(-1))/2,
    ) 
    f1e4theta04530N21e5delta05Vinf01gammal = (f = 1e-4,
        ...
        V∞ = 0.1,
        S∞ = (1e-5*tand(0.453)^2)/((1e-4)^2),
        γ = (3-1e-5*tand(0.453)^2*10^(8))*(cosd(0.453)*(3*(1+1e-5*tand(0.453)^2*10^(8))-4*0.5*1e-5*tand(0.453)^2*(10)^(8)))^(-1),
    )
    f1e4theta13587N21e5delta05Vinf01gammau = (f = 1e-4,
        ...
        γ = (cosd(1.3587)*(1+(1e-5*tand(1.3587)^2)/((1e-4)^2)*(1-0.5)))^(-1),
    )
    f1e4theta13587N21e5delta05Vinf01gammam = (f = 1e-4,
        ...
        V∞ = 0.1,
        S∞ = (1e-5*tand(1.3587)^2)/((1e-4)^2),
        γ = ((cosd(1.3587)*(1+0.5*1e-5*tand(1.3587)^2*10^(8)))^(-1)+(3-1e-5*tand(1.3587)^2*10^(8))*(cosd(1.3587)*(3*(1+1e-5*tand(1.3587)^2*10^(8))-4*0.5*1e-5*tand(1.3587)^2*(10)^(8)))^(-1))/2,
    ) 
    f1e4theta13587N21e5delta05Vinf01gammal = (f = 1e-4,
        ...
        V∞ = 0.1,
        S∞ = (1e-5*tand(1.3587)^2)/((1e-4)^2),
        γ = (3-1e-5*tand(1.3587)^2*10^(8))*(cosd(1.3587)*(3*(1+1e-5*tand(1.3587)^2*10^(8))-4*0.5*1e-5*tand(1.3587)^2*(10)^(8)))^(-1),
    )
    f1e4theta22637N21e5delta05Vinf01gammau = (f = 1e-4,
        ...
        γ = (cosd(2.2637)*(1+(1e-5*tand(2.2637)^2)/((1e-4)^2)*(1-0.5)))^(-1),
    )
    f1e4theta22637N21e5delta05Vinf01gammam = (f = 1e-4,
        ...
        V∞ = 0.1,
        S∞ = (1e-5*tand(2.2637)^2)/((1e-4)^2),
        γ = ((cosd(2.2637)*(1+0.5*1e-5*tand(2.2637)^2*10^(8)))^(-1)+(3-1e-5*tand(2.2637)^2*10^(8))*(cosd(2.2637)*(3*(1+1e-5*tand(2.2637)^2*10^(8))-4*0.5*1e-5*tand(2.2637)^2*(10)^(8)))^(-1))/2,
    ) 
    f1e4theta22637N21e5delta05Vinf01gammal = (f = 1e-4,
        ...
        V∞ = 0.1,
        S∞ = (1e-5*tand(2.2637)^2)/((1e-4)^2),
        γ = (3-1e-5*tand(2.2637)^2*10^(8))*(cosd(2.2637)*(3*(1+1e-5*tand(2.2637)^2*10^(8))-4*0.5*1e-5*tand(2.2637)^2*(10)^(8)))^(-1),
    )
    f1e4theta31676N21e5delta05Vinf01gammau = (f = 1e-4,
        ...
        γ = (cosd(3.1676)*(1+(1e-5*tand(3.1676)^2)/((1e-4)^2)*(1-0.5)))^(-1),
    )
    f1e4theta31676N21e5delta05Vinf01gammam = (f = 1e-4,
        ...
        V∞ = 0.1,
        S∞ = (1e-5*tand(3.1676)^2)/((1e-4)^2),
        γ = ((cosd(3.1676)*(1+0.5*1e-5*tand(3.1676)^2*10^(8)))^(-1)+(3-1e-5*tand(3.1676)^2*10^(8))*(cosd(3.1676)*(3*(1+1e-5*tand(3.1676)^2*10^(8))-4*0.5*1e-5*tand(3.1676)^2*(10)^(8)))^(-1))/2,
    ) 
